...
5. `05-llm-batch-notebook.ipynb` — the Colab notebook that sends diary entries to an LLM with that prompt. It looks for `04-llm-annotation-prompt.md` in its project folder.
6. `human-annotations/` — the filled tables, 406 rows in the same order:
